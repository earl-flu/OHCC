                        ...
                        <div class="grid grid-cols-6 gap-6" x-show.transition.in="step === 1">
                            ...
                            <div class="col-span-6">
                                <label class="block text-sm">
                                    ...
                                    <input
                                        class="border border-gray-200 rounded block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                        name="middle_name" value="{{old('middle_name') ?: $patient->middle_name}}" />
                                </label>
                            </div>
                                ...
                                <label class="block text-sm">
                                    ...
                                    <select
                                        ...
                                        <option value="{{$gender_value}}"
                                            {{(old('gender_id') ?: $patient->gender_id) == $gender_value ? 'selected' : ''}}>
                                            {{$gender}}</option>
                                        @endforeach
                                    </select>
                                </label>
                                ...
                                <label class="block text-sm">
                                    ...
                                    <select
                                        ...
                                        <option value="{{$municipality->id}}" id="{{$municipality->id_code}}"
                                            {{(old('municipality_id') ?: $patient->municipality_id) == $municipality->id ? 'selected' : ''}}>
                            ...
                            {{-- <div class="col-span-6">
                                <label class="block text-sm">
                                    ...
                                    <input type="date"
                                        class="border border-gray-200 rounded block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                        name="birthday" value="{{old('birthday') ?: $patient->birthday}}" />
                            </label>
                        </div> --}}
                    </div>
                    <!-- END OF STEP 1-->
                            ...
                            <label class="block text-sm">
                                ...
                                <select name="case_definition_id" x-model="casedefinition"
                                    ...
                                    <option value="{{$case_def_value}}"
                                        {{ (old('case_definition_id') ?: $patient->case_definition_id) == $case_def_value ? 'selected' : ''}}>
                                        {{$case_def}}</option>
                                    @endforeach
                                </select>
                            </label>
                            ...
                            <label class="block text-sm">
                                ...
                                <select name="symptoms_classification_id"
                                    ...
                                    <option value="{{$symptom_value}}"
                                        {{ (old('symptoms_classification_id') ?: $patient->symptoms_classification_id) == $symptom_value ? 'selected' : ''}}>
                                        {{$symptom}}</option>
                                    @endforeach
                                </select>
                            </label>
                            ...
                            <label class="block text-sm">
                                ...
                                <select name="patient_status_id"
                                    ...
                                    <option value="{{$stat->id}}"
                                        {{ (old('patient_status_id') ?: $patient->patient_status_id) == $stat->id ? 'selected' : ''}}>
                                        {{$stat->name}}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="health_facility_id" id="health_facility" class="js-example-basic-single">
                                    ...
                                    <optgroup label="{{$municipality}}">
                                        ...
                                        <option value={{$g_hospital->id}}
                                            {{ (old('health_facility_id') ?: $patient->health_facility_id) == $g_hospital->id ? 'selected' : ''}}>
                        ...
                        <div class="col-span-6 ">
                            <label class="block text-sm">
                                ...
                                <select name="bed_id"
                                    ...
                                    <option value="{{$bed_value}}"
                                        {{ (old('bed_id') ?: $patient->bed_id) == $bed_value ? 'selected' : ''}}>
                                        {{$bed}}</option>
                                    @endforeach
                                </select>
                            </label>
                        ...
                        <div class="col-span-6">
                            <label class="block text-sm">
                                ...
                                <textarea name="remarks"
                                    ...
                                    rows="3">{{old('remarks') ?: $patient->remarks}}</textarea>
                            </label>
                        </div>
                    </div>
                    <!--END OF STEP 2-->
    ...
    <script>
        //ALPINE
            function app() {
                ...
                return {
                    step: 1,
                    casedefinition: "{{(old('case_definition_id') ?: $patient->case_definition_id)}}" || '',
                }
            }
            ...
            $(function(){
                ...
                // const oldMunicipality = "{{old('municipality') ?: $patient->municipality}}";
                const oldBarangay= "{{old('barangay') ?: $patient->barangay}}";
